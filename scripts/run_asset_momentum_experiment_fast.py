...
def main():
    ...
    logger.info(f"- Best: {best_sharpe['method_name']} ({best_sharpe['sharpe']:.3f} Sharpe, {best_sharpe['sharpe'] - baseline['sharpe']:+.3f} vs baseline)")
    logger.info("")
    logger.info("Note: Fast mode uses recent 8 years only. Run full experiment for final validation.")
